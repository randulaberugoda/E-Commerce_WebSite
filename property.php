    ...
    <style>
        * {
        ...
        .search-bar {
            ...
            overflow: hidden;
            align-items: center;
            margin: 2rem 0 1rem; /* Adjust the top margin to move it down */
        }
...
// Fetch fashion items from the database
$query = "SELECT * FROM postad WHERE category = 'Property'";
...
if ($result->num_rows > 0) {
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        $firstPhoto = isset($photos[0]) ? $photos[0] : 'default.jpg'; // Fallback to a default image if no photos
